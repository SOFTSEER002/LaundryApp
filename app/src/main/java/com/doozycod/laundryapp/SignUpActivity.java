                ...
                if (retype_pass_et.getText().toString().equals("")) {
                    ...
                    if (!password_et.getText().toString().equals(retype_pass_et.getText().toString())) {
                        ...
                        if (password_et.getText().toString().length() < 6) {
                            ...
                            dbHelper.insertSignup(first_name_et.getText().toString(), last_name_et.getText().toString(), email_et.getText().toString(), phone_number_et.getText().toString(), password_et.getText().toString());
                            sharedPreferenceMethod.spInsert(email_et.getText().toString(), password_et.getText().toString(), first_name_et.getText().toString(), last_name_et.getText().toString(), phone_number_et.getText().toString());
